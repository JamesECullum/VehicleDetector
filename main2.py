...
width_min = 50 # Largura minima do retangulo
height_min = 50  # Altura minima do retangulo

offset = 1  # Erro permitido entre pixel

pos_line = 150  # Posição da linha de contagem
...
cap = cv2.VideoCapture('testVidBus6.mp4')
